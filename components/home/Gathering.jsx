    ...
    <section className="py-28">
      <div className="max-w-7xl mx-auto xl:flex">
        <div className="flex flex-col items-center">
          <Image src={familyGatheringMobile} className="block shadow-2xl md:hidden" alt="gathering-mobile" />

          <Image src={familyGatheringTablet} className="hidden shadow-2xl relative md:block xl:hidden" alt="gathering-tablet" />

          <Image src={familyGatheringDesktop} className="hidden shadow-2xl relative xl:block" alt="gathering-desktop" />
        ...
        <div className="flex flex-col items-center justify-center text-center mt-16 px-4 md:max-w-[457px] md:mx-auto xl:justify-start xl:items-start xl:text-left xl:space-y-12">
            ...
            <button className="btn-secondary w-[245px] h-[64px] mt-6" onClick={() => router.push('/reservations')}>Book a table</button>
        </div>
      </div>
    </section>
  );
